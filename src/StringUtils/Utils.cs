...
public static class Utils
{
    ...
    public static (long, Error) ParseBufferSize(string size)
    {
        ...
        {
            return (0, Error.WithLoc(1, "Buffer size string is null or empty."));
        }
        ...
        if (size.EndsWith("pb", StringComparison.Ordinal)) { multiplier = 1024L * 1024 * 1024 * 1024 * 1024; numPart = size[..^2]; }
